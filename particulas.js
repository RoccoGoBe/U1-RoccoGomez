...
//// ------------------------------------------------------------
//// Crear una funcion de simulacion que permita realizar la 
//// animacion de las particulas de manera aleatoria, y que incluya 
//// la posicion y velocidad de cada una.




     //// Dentro de la función de simulación utilizar la función Math.random() para generar números aleatorios. Calcular la posición y velocidad.



     //// Almacenar la posición de cada partícula y su color
